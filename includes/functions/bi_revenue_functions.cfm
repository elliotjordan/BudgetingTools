...
<cffunction name="getProjectinatorDataV1" output="true">
	<cfargument name="selectedCampus" required="false" default="ALL">
	<cfargument name="selectedRC" required="false" default="ALL">
...
FROM ch_user.b2_rpt_chp_report_v1(giveninst => '#selectedCampus#', givenrc => '#selectedRC#')
	</cfquery>
...
<cffunction name="getProjectinatorData" output="true">
	...
	<cfargument name="outputType" required="false" default="excel">
...
<!---<cffunction name="getProjectinatorData_fancy" output="true">
