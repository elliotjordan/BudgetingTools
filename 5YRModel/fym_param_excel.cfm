...
<cfset fymParamDataDump = getExcelParamDataDump() />
...
<cfoutput>
	<table>
		<tr>
				...
				<td class="header">userentry</td>
				<td class="header">paramcat</td>
				<td class="header">paramtype</td>
				<td class="header">param</td>
				<td class="header">fy1920</td>
				<td class="header">fy2021</td>
				<td class="header">fy2122</td>
				<td class="header">fy2223</td>
				<td class="header">fy2324</td>
				<td class="header">fy2425</td>
				<td class="header">comments</td>
				<td class="header">source</td>
				<td class="header">paramformat</td>
				<td class="header">active</td>
				<td class="header">fund_grp_cd</td>
				<td class="header">fund_grp_desc</td>
				<td class="header">inst_cd</td>
				<td class="header">acad_career_cd</td>
				<td class="header">res</td>
				<td class="header">param_id</td>
		</tr>
		<cfloop query="fymParamDataDump">
			<tr>
				<td>#oid#</td>
				<td>#userentry#</td>
				<td>#paramcat#</td>
...
<cfheader
	...
	value="attachment; filename=5YRModel_fym_params.xls"
	/>
