<cfoutput>
					<div class="workSaver">
				        ...
				        <tbody>
				        	<tr>
				            	<td>Only Show Minimum UBO Projected Hours:</td>
				            	<td><input id="specialmin" name="specialmin" type="text"></td>
				        	</tr>
				        	<tr>
				            	<td>Don't Show over Maximum UBO Projected Hours:</td>
				            	<td><input id="specialmax" name="specialmax" type="text"></td>
				        	</tr>
				    	</tbody>
				    </table>
