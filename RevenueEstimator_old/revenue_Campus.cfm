...
<cfif IsDefined("form") AND StructKeyExists(form,"dwnldBtn")>
	...
	<cfset ExcelSelect = getExcelDownloadData(urlCampus,"NONE","V1")>
   		<cfif IsDefined("ExcelSelect") AND ExcelSelect.recordcount GT 0>
			...
			<cfheader name="Content-Disposition" value="inline; filename=FY19_Credit_Hour_Revenue_Projection_Worksheet.xls">   
			...
			<cfform action="revenue_Campus.cfm">
				<div class="controlBar">
					...
					<div class="controlBinTRC">
						<input id="uirrBtn" type="submit" name="uirrBtn" class="reportBtn" value="Credit Hours Used in Budget">
					</div>
