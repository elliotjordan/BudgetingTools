					...
					<table id="gradFeesTable" class="feeCodeTable">
						...
						<tbody>
							...
							<!--- BEGIN YEAR TWO COLUMNS --->
									...
									</td> <!--- TODO: automate replacement of solid spacer bar for visual separation of fiscal years with FY20 Actuals --->
									<td class="darker">
										#MACHINEHOURS_YR2#
									</td>
									<td>
										<!--- TODO: Starting value should be from Campus preferences in Long Cycle Year, but should be what was submitted YR1 during YR2  
										            This is so that we have a clean slate during Projection year, but reference prior setting during Modification year. --->
